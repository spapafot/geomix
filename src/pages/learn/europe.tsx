...
export default function LearnEuropePage() {
  return (
    <>
      <Head>
        <title>Χώρες Ευρώπης — Πρωτεύουσες & Γεωγραφία | GeoMix</title>
        <meta name="description" content="Μάθε τις 44 χώρες της Ευρώπης και τις πρωτεύουσές τους. Γεωγραφικά στοιχεία, ενδιαφέροντα γεγονότα και σύνδεσμοι για κουίζ." />
        <meta name="keywords" content="χώρες ευρώπης, πρωτεύουσες ευρώπης, ευρωπαϊκές χώρες, γεωγραφία ευρώπης, κράτη ευρώπης" />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Χώρες Ευρώπης — Πρωτεύουσες & Γεωγραφία | GeoMix" />
        <meta property="og:description" content="Πλήρης οδηγός για τις 44 χώρες της Ευρώπης με πρωτεύουσες και γεωγραφικά στοιχεία." />
      ...
      <div className="min-h-screen bg-slate-950 text-white">
        ...
        <main className="max-w-3xl mx-auto px-6 py-16">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-4xl font-extrabold text-slate-100">Χώρες Ευρώπης</h1>
          </div>

          <p className="text-slate-400 text-lg leading-relaxed mb-12">
            Η Ευρώπη αποτελείται από <strong className="text-slate-300">44 κυρίαρχα κράτη</strong> με συνολικό πληθυσμό περίπου <strong className="text-slate-300">748 εκατομμυρίων</strong> κατοίκων και έκταση <strong className="text-slate-300">10,5 εκατομμυρίων τ.χλμ.</strong>
          </p>

          <section className="mb-12">
            <h2 className="text-2xl font-bold mb-4 text-slate-100">Γεωγραφική Εισαγωγή</h2>
            <p className="text-slate-400 leading-relaxed mb-4">
              Η Ευρώπη είναι η δεύτερη μικρότερη ήπειρος, αλλά η τρίτη πιο πυκνοκατοικημένη στον κόσμο. Εκτείνεται από τον Ατλαντικό Ωκεανό στα δυτικά ως τα Ουράλια Όρη στα ανατολικά, και από τον Αρκτικό Ωκεανό στα βόρεια ως τη Μεσόγειο Θάλασσα στα νότια.
            </p>
            <p className="text-slate-400 leading-relaxed mb-4">
              Τα σημαντικότερα ορεινά συστήματα είναι οι <strong className="text-slate-300">Άλπεις</strong> (με ψηλότερη κορυφή το Mont Blanc, 4.808 μ.), τα <strong className="text-slate-300">Πυρηναία</strong> μεταξύ Ισπανίας-Γαλλίας, τα <strong className="text-slate-300">Καρπάθια</strong> στην Κεντρική Ευρώπη και ο <strong className="text-slate-300">Καύκασος</strong> στα νοτιοανατολικά σύνορα.
            </p>
            <p className="text-slate-400 leading-relaxed">
              Οι σημαντικότεροι ποταμοί είναι ο Βόλγας (μεγαλύτερος στην Ευρώπη), ο Ρήνος, ο Δούναβης (διασχίζει 10 χώρες) και ο Θάμεσης. Η Ευρώπη φιλοξενεί ορισμένες από τις παλαιότερες και μεγαλύτερες πόλεις στον κόσμο: το Λονδίνο, το Παρίσι, τη Ρώμη και τη Μόσχα.
            </p>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-bold mb-6 text-slate-100">Όλες οι Χώρες & Πρωτεύουσες</h2>
          ...
          <div className="bg-slate-900 border border-slate-700/60 rounded-2xl p-6">
            ...
            <p className="text-slate-400 text-sm mb-4">Ξέρεις όλες τις ευρωπαϊκές χώρες στον χάρτη;</p>
            <div className="flex flex-wrap gap-3">
              <Link href="/quiz/europe" className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 rounded-lg text-sm font-semibold transition-colors">
                🗺️ Χώρες Ευρώπης
              </Link>
              <Link href="/quiz/europe-capitals" className="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-lg text-sm font-semibold transition-colors">
                🏛️ Πρωτεύουσες
              </Link>
              <Link href="/quiz/europe-flags" className="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-lg text-sm font-semibold transition-colors">
                🚩 Σημαίες
              </Link>
            </div>
          </div>
