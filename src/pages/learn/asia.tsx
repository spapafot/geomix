...
export default function LearnAsiaPage() {
  return (
    <>
      <Head>
        <title>Ασία — Πρωτεύουσες & Γεωγραφία | GeoMix</title>
        <meta
          name="description"
          content="Μάθε τις χώρες της Ασίας και τις πρωτεύουσές τους. Η μεγαλύτερη ήπειρος — από την Ιαπωνία ως την Τουρκία. Γεωγραφία, στοιχεία και κουίζ."
        />
        <meta
          name="keywords"
          content="χώρες ασίας, πρωτεύουσες ασίας, ασιατικές χώρες, γεωγραφία ασίας, κράτη ασίας"
        />
        <meta name="robots" content="index, follow" />
        <meta
          property="og:title"
          content="Ασία — Πρωτεύουσες & Γεωγραφία | GeoMix"
        />
        <meta
          property="og:description"
          content="Πλήρης οδηγός για τις χώρες της Ασίας με πρωτεύουσες και γεωγραφικά στοιχεία."
        />
      ...
      <div className="min-h-screen bg-slate-950 text-white">
        ...
        <main className="max-w-3xl mx-auto px-6 py-16">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-4xl font-extrabold text-slate-100">Ασία</h1>
          </div>

          <p className="text-slate-400 text-lg leading-relaxed mb-12">
            Η Ασία είναι η{" "}
            <strong className="text-slate-300">μεγαλύτερη ήπειρος</strong> στον
            κόσμο, τόσο σε έκταση (
            <strong className="text-slate-300">44,5 εκ. τ.χλμ.</strong>) όσο και
            σε πληθυσμό (
            <strong className="text-slate-300">4,7 δισεκατομμύρια</strong>{" "}
            κάτοικοι — πάνω από το 60% του παγκόσμιου πληθυσμού).
          </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-400 leading-relaxed mb-4">
              Η Ασία εκτείνεται από τον Αρκτικό Ωκεανό στα βόρεια ως τον Ινδικό
              Ωκεανό στα νότια, και από τον Ουράλιο Ποταμό στα δυτικά ως τον
              Ειρηνικό Ωκεανό στα ανατολικά. Συνορεύει με την Ευρώπη στα δυτικά
              (σχηματίζοντας μαζί της τη{" "}
              <strong className="text-slate-300">Ευρασία</strong>) και με την
              Αφρική μέσω της Διώρυγας του Σουέζ.
            </p>
            <p className="text-slate-400 leading-relaxed mb-4">
              Η Ασία φιλοξενεί τη{" "}
              <strong className="text-slate-300">
                ψηλότερη κορυφή στον κόσμο
              </strong>
              , το Έβερεστ (8.849 μ.) στα Ιμαλάια, αλλά και το{" "}
              <strong className="text-slate-300">
                χαμηλότερο σημείο της ξηράς
              </strong>
              , τη Νεκρά Θάλασσα (−430 μ.). Τα μεγαλύτερα ποτάμια του κόσμου — ο
              Γάγγης, ο Ινδός, ο Γιανγκτσέ και ο Μεκόνγκ — ξεκινούν από αυτή την
              ήπειρο.
            </p>
            <p className="text-slate-400 leading-relaxed">
              Η Ασία χωρίζεται σε πέντε υποπεριοχές:{" "}
              <strong className="text-slate-300">Ανατολική Ασία</strong> (Κίνα,
              Ιαπωνία, Κορέα),{" "}
              <strong className="text-slate-300">Νοτιοανατολική Ασία</strong>{" "}
              (Ταϊλάνδη, Βιετνάμ, κ.ά.),{" "}
              <strong className="text-slate-300">Νότια Ασία</strong> (Ινδία,
              Πακιστάν),{" "}
              <strong className="text-slate-300">Κεντρική Ασία</strong> και{" "}
              <strong className="text-slate-300">
          ...
          <div className="bg-slate-900 border border-slate-700/60 rounded-2xl p-6">
            ...
            <p className="text-slate-400 text-sm mb-4">
              Ξέρεις πού βρίσκεται κάθε ασιατική χώρα στον χάρτη;
            </p>
