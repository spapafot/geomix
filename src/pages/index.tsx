...
export default function LandingPage() {
  ...
  return (
    ...
    <Head>
      ...
      <meta name="description" content="Δωρεάν διαδραστικό κουίζ γεωγραφίας για μαθητές. Μάθε τις περιφέρειες και τους νομούς της Ελλάδας, τις χώρες και τις πρωτεύουσες της Ευρώπης με διασκεδαστικό τρόπο." />
      <meta name="keywords" content="γεωγραφία, κουίζ γεωγραφίας, ελλάδα, περιφέρειες ελλάδας, νομοί ελλάδας, χώρες ευρώπης, πρωτεύουσες ευρώπης, εκπαίδευση, μαθητές, δημοτικό, γυμνάσιο, λύκειο, διαδραστικός χάρτης" />
      <meta name="robots" content="index, follow" />
      <meta property="og:title" content="GeoMix — Μάθε τη Γεωγραφία της Ελλάδας και της Ευρώπης" />
      <meta property="og:description" content="Δωρεάν διαδραστικό κουίζ γεωγραφίας για μαθητές. Περιφέρειες, νομοί, χώρες Ευρώπης και πρωτεύουσες." />
      ...
      <div className="relative z-10 flex flex-col items-center px-6 py-20 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col gap-10 w-full">
          {GAME_GROUPS.map((group, gi) => (
            <BlurFade key={group.label} delay={gi === 0 ? 0.2 : 0} duration={0.25} inView className="w-full">
              {/* Group header */}
              <div className="flex items-center gap-3 mb-4">
                <span className="text-lg">{group.flag}</span>
                <h2 className="text-sm font-semibold text-slate-300 uppercase tracking-widest">{group.label}</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {group.games.map((game, i) => (
                  <BlurFade key={game.id} delay={i * 0.04} duration={0.2} inView>
                    <motion.button
                    ...
                    >
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="font-bold text-slate-100 text-base mb-1">{game.title}</h3>
                      ...
                      {game.available && (
                        <div className="mt-4 flex items-center justify-between">
                          <div className={`flex items-center gap-1.5 text-xs font-semibold ${game.playColor}`}>
