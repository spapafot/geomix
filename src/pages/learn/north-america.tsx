...
export default function LearnNorthAmericaPage() {
  return (
    <>
      <Head>
        <title>Βόρεια Αμερική — Πρωτεύουσες & Γεωγραφία | GeoMix</title>
        <meta
          name="description"
          content="Μάθε τις χώρες της Βόρειας Αμερικής και τις πρωτεύουσές τους. Από τον Καναδά ως τον Παναμά — γεωγραφία, στοιχεία και κουίζ."
        />
        <meta
          name="keywords"
          content="χώρες βόρειας αμερικής, πρωτεύουσες βόρειας αμερικής, γεωγραφία βόρειας αμερικής, κεντρική αμερική"
        />
        <meta name="robots" content="index, follow" />
        <meta
          property="og:title"
          content="Βόρεια Αμερική — Πρωτεύουσες & Γεωγραφία | GeoMix"
        />
        <meta
          property="og:description"
          content="Οδηγός γεωγραφίας για τις χώρες της Βόρειας Αμερικής με πρωτεύουσες και στοιχεία."
        />
      ...
      <div className="min-h-screen bg-slate-950 text-white">
        ...
        <main className="max-w-3xl mx-auto px-6 py-16">
          ...
          <p className="text-slate-400 text-lg leading-relaxed mb-12">
            Η Βόρεια Αμερική εκτείνεται από τον{" "}
            <strong className="text-slate-300">Αρκτικό Ωκεανό</strong> στα
            βόρεια ως τον <strong className="text-slate-300">Παναμά</strong> στα
            νότια. Περιλαμβάνει{" "}
            <strong className="text-slate-300">23 κυρίαρχα κράτη</strong>, με
            συνολική έκταση{" "}
            <strong className="text-slate-300">24,7 εκ. τ.χλμ.</strong> και
            πληθυσμό περίπου{" "}
            <strong className="text-slate-300">600 εκατομμυρίων</strong>.
          </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-400 leading-relaxed mb-4">
              Η Βόρεια Αμερική χωρίζεται γεωγραφικά σε τρεις βασικές περιοχές:
              τον <strong className="text-slate-300">Καναδά και τις ΗΠΑ</strong>{" "}
              (Αγγλόφωνη Βόρεια Αμερική), το{" "}
              <strong className="text-slate-300">Μεξικό</strong> (Ισπανόφωνη
              Βόρεια Αμερική) και την{" "}
              <strong className="text-slate-300">Κεντρική Αμερική</strong> με τα
              νησιά της Καραϊβικής.
            </p>
            <p className="text-slate-400 leading-relaxed mb-4">
              Τα Βραχώδη Όρη (Rocky Mountains) στα δυτικά και τα Απαλάχια στα
              ανατολικά αποτελούν τα κύρια ορεινά συστήματα. Ο{" "}
              <strong className="text-slate-300">Μισισιπής-Μιζούρι</strong>{" "}
              είναι το μεγαλύτερο ποτάμιο σύστημα της ηπείρου. Τα{" "}
              <strong className="text-slate-300">Μεγάλα Λιμάνια</strong> (Great
              Lakes) στα σύνορα ΗΠΑ-Καναδά αποτελούν τη μεγαλύτερη συλλογή
              γλυκού νερού στον κόσμο.
            </p>
            <p className="text-slate-400 leading-relaxed">
              Η Κεντρική Αμερική αποτελείται από 7 μικρές χώρες μεταξύ Μεξικού
              και Κολομβίας. Η Καραϊβική φιλοξενεί δεκάδες νησιά, εκ των οποίων
              η Κούβα, η Αϊτή/Δομινικανή Δημοκρατία, η Τζαμάικα και το Πουέρτο
              Ρίκο είναι οι μεγαλύτερες.
            </p>
          </section>
