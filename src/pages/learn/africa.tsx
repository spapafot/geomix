...
export default function LearnAfricaPage() {
  return (
    <>
      <Head>
        <title>Χώρες Αφρικής — Πρωτεύουσες & Γεωγραφία | GeoMix</title>
        <meta name="description" content="Μάθε τις 53 χώρες της Αφρικής και τις πρωτεύουσές τους. Γεωγραφικά στοιχεία, ενδιαφέροντα γεγονότα και κουίζ." />
        <meta name="keywords" content="χώρες αφρικής, πρωτεύουσες αφρικής, αφρικανικές χώρες, γεωγραφία αφρικής, κράτη αφρικής" />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Χώρες Αφρικής — Πρωτεύουσες & Γεωγραφία | GeoMix" />
        <meta property="og:description" content="Πλήρης οδηγός για τις 53 χώρες της Αφρικής με πρωτεύουσες και γεωγραφικά στοιχεία." />
      ...
      <div className="min-h-screen bg-slate-950 text-white">
        ...
        <main className="max-w-3xl mx-auto px-6 py-16">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-4xl font-extrabold text-slate-100">Χώρες Αφρικής</h1>
          </div>

          <p className="text-slate-400 text-lg leading-relaxed mb-12">
            Η Αφρική είναι η <strong className="text-slate-300">δεύτερη μεγαλύτερη ήπειρος</strong> και φιλοξενεί τον <strong className="text-slate-300">μεγαλύτερο αριθμό κρατών</strong> στον κόσμο — <strong className="text-slate-300">54 χώρες</strong> συνολικά. Έκταση: <strong className="text-slate-300">30,3 εκ. τ.χλμ.</strong>, πληθυσμός: περίπου <strong className="text-slate-300">1,4 δισεκατομμύρια</strong>.
          </p>

          <section className="mb-12">
            <h2 className="text-2xl font-bold mb-4 text-slate-100">Γεωγραφική Εισαγωγή</h2>
            <p className="text-slate-400 leading-relaxed mb-4">
              Η Αφρική εκτείνεται από τη Μεσόγειο Θάλασσα στα βόρεια ως τον Ακρωτήριο της Καλής Ελπίδας στα νότια. Χωρίζεται σε πέντε υποπεριοχές: <strong className="text-slate-300">Βόρεια Αφρική</strong> (Μαγκρέμπ + Αίγυπτος), <strong className="text-slate-300">Δυτική Αφρική</strong>, <strong className="text-slate-300">Κεντρική Αφρική</strong>, <strong className="text-slate-300">Ανατολική Αφρική</strong> και <strong className="text-slate-300">Νότια Αφρική</strong>.
            </p>
            <p className="text-slate-400 leading-relaxed mb-4">
              Η μεγαλύτερη έρημος στον κόσμο, η <strong className="text-slate-300">Σαχάρα</strong> (9,2 εκ. τ.χλμ.), καλύπτει το μεγαλύτερο μέρος της Βόρειας Αφρικής. Ο <strong className="text-slate-300">Νείλος</strong>, ο μακρύτερος ποταμός στον κόσμο (6.650 χλμ.), πηγάζει από την κεντρική Αφρική και εκβάλλει στη Μεσόγειο. Ο <strong className="text-slate-300">Κονγκό</strong> είναι ο δεύτερος σε παροχή ποταμός στον κόσμο.
            </p>
            <p className="text-slate-400 leading-relaxed">
              Το ψηλότερο βουνό της Αφρικής είναι το <strong className="text-slate-300">Κιλιμάντζαρο</strong> στην Τανζανία (5.895 μ.). Η Μεγάλη Ρηγματογόνος Ζώνη (Great Rift Valley) διασχίζει την Ανατολική Αφρική από βορρά ως νότο, φιλοξενώντας ορισμένες από τις μεγαλύτερες λίμνες στον κόσμο.
            </p>
          </section>
          ...
          <div className="bg-slate-900 border border-slate-700/60 rounded-2xl p-6">
            ...
            <p className="text-slate-400 text-sm mb-4">Ξέρεις πού βρίσκεται κάθε αφρικανική χώρα στον χάρτη;</p>
            <div className="flex flex-wrap gap-3">
              <Link href="/quiz/africa" className="px-4 py-2 bg-amber-600 hover:bg-amber-500 rounded-lg text-sm font-semibold transition-colors">
                🗺️ Χώρες Αφρικής
              </Link>
              <Link href="/quiz/africa-capitals" className="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-lg text-sm font-semibold transition-colors">
                🏛️ Πρωτεύουσες
              </Link>
              <Link href="/quiz/africa-flags" className="px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-lg text-sm font-semibold transition-colors">
                🚩 Σημαίες
              </Link>
            </div>
          </div>
